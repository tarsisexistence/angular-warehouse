...
describe('Apparel Actions', () => {
  ...
  describe('LoadApparel action', () => {
    ...
    // price: 19.99, title: 'Winter Hat Mern', type: 'accessories' } ]; const action = new LoadApparelSuccess(payload);
    //  expect({ ...action }).toEqual({ type: ApparelShopActionTypes.LoadApparelSuccess, payload }); });  });
  });
});